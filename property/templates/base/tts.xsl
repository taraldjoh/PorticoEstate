					...
					<xsl:choose>
						<xsl:when test="simple !='1'">
							...
							<div class="pure-control-group">
								...
								<select name="{$select_priority_name}" class="pure-input-1-4" >
							...
							<div class="pure-control-group">
								...
								<select id="status_id" name="values[status]" class="pure-input-1-4" >
									<xsl:attribute name="title">
				...
				<fieldset>
					...
					<xsl:if test="simple !='1'">
						<div class="pure-control-group">
							...
							<select name="make_relation" id="make_relation" class="pure-input-1-4" >
								<xsl:attribute name="title">
									<xsl:value-of select="$lang_make_relation"/>
								</xsl:attribute>
								<option value="">
					...
					<div class="pure-control-group">
						...
						<select name="{$select_priority_name}" title="{$lang_priority_statustext}" class="pure-input-1-4" >
							<xsl:if test="simple ='1'">
							...
							<xsl:choose>
								<xsl:when test="value_order_id!=''">
									...
									<xsl:choose>
										<xsl:when test="branch_list!=''">
											<div class="pure-control-group">
												...
												<select name="values[branch_id]" class="pure-input-1-4" >
													<xsl:attribute name="title">
									...
									<div class="pure-control-group">
										...
										<select name="values[order_dim1]" class="pure-input-1-4" >
											<xsl:attribute name="title">
												<xsl:value-of select="php:function('lang', 'order_dim1')"/>
											</xsl:attribute>
											<xsl:attribute name="data-validation">
									...
									<xsl:if test="enable_unspsc = 1">
										<div class="pure-control-group">
											...
											<select name="values[tax_code]" class="pure-input-1-4" >
												<xsl:attribute name="title">
													<xsl:value-of select="$lang_tax_code"/>
												</xsl:attribute>
												<xsl:attribute name="data-validation">
